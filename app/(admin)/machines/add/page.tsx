...
export default function AddMachinePage() {
    ...
    React.useEffect(() => {
        if (modelName) {
            setValue("slug", modelName.toLowerCase().replace(/[^a-z0-9]+/g, "-").replace(/(^-|-$)+/g, ""));
        } else {
            setValue("slug", "");
        }
    }, [modelName, setValue]);
    ...
    return (
        <div className="w-full mx-auto relative h-full flex flex-col">
            <Header>
                <HeaderGroup className="gap-6">
                    ...
                    <HeaderGroup className="flex-col">
                        <HeaderTitle>Add Machine</HeaderTitle>
            ...
            <div className="w-full mx-auto animate-in fade-in duration-500 overflow-y-auto pt-6 px-1">
                <form onSubmit={handleSubmit(onSubmit)} id="add-machine-form">
                                        ...
                                        <Controller
                                            ...
                                            render={({ field }) => (
                                                <Field>
                                                    ...
                                                    <Input placeholder="auto-generated-slug" readOnly className="cursor-not-allowed text-muted-foreground" {...field} />
                                            ...
                                            <div key={item.id} className="bg-slate-50 p-3 rounded-lg border border-slate-100 mb-3">
                                                <div className="flex items-start gap-3">
                                                    ...
                                                    <Button
                                                        ...
                                                        onClick={() => {
                                                            removeSpec(index);
                                                            // Cleanup custom toggle state if present
